...
import aboutFallbackImg from '../../assets/about.png';
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              variants={fadeUpVariants}
              className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-6 pb-2 border-t border-[#B3916D]/35"
            >
              {/* Stat 1 */}
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#C4B5A5] mt-0.5">
                  Concept Experiences
                </span>
              </div>
          ...
          {/* ================= RIGHT PORTRAIT FRAME WITH 3D PHYSICS ================= */}
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                <img
                  src={PERSONAL_INFO.profilePhotoPlaceholder || aboutFallbackImg}
